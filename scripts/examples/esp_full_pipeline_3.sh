...
# ============================================================================
# Full Antibody Design Pipeline — Esp Target, 3rd Attempt (Enterococcus faecalis)
# ============================================================================
# Hotspots: A156, A157, A160
#
# Usage: CUDA_VISIBLE_DEVICES=0 bash scripts/examples/esp_full_pipeline_3.sh
# ============================================================================
...
echo "=============================================="
echo "Antibody Design Pipeline — Esp Target (3rd)"
