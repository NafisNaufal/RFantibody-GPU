...
# ============================================================================
# Full Antibody Design Pipeline — Esp Target (Enterococcus faecalis)
# ============================================================================
# Runs the complete antibody design workflow against the Esp surface protein
# (AlphaFold model) from Enterococcus faecalis:
...
#
# Usage: CUDA_VISIBLE_DEVICES=0 bash scripts/examples/esp_full_pipeline.sh
# ============================================================================
...
# Input files
TARGET_PDB="scripts/examples/example_inputs/AF_Esp.pdb"
...
echo "=============================================="
echo "Antibody Design Pipeline — Esp Target (AF)"
echo "Enterococcus faecalis Surface Protein Esp"
echo "=============================================="
