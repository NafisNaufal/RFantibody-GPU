...
# ============================================================================
# Full Antibody Design Pipeline — ACE Target (Enterococcus faecalis)
# ============================================================================
# Runs the complete antibody design workflow against the Ace MSCRAMM protein
# (Collagen Adhesin, PDB: 2Z1P) from Enterococcus faecalis:
...
#
# Usage: CUDA_VISIBLE_DEVICES=0 bash scripts/examples/ace_full_pipeline.sh
# ============================================================================
...
# Output directory
OUTPUT_DIR="designs/ace_pipeline"

# RFdiffusion parameters
NUM_DESIGNS=200
DESIGN_LOOPS="H1:10,H2:6,H3:16"
HOTSPOTS="A180,A182,A193,A195"
DIFFUSER_T=50
...
echo "=============================================="
echo "Antibody Design Pipeline — ACE Target (2Z1P)"
