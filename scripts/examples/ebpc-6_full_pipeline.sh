...
# ============================================================================
# Full Antibody Design Pipeline — EBPC Target, Attempt 6
# ============================================================================
...
#
# Usage: CUDA_VISIBLE_DEVICES=0 bash gemastik-2026-scripts/rfantibody/ebpc-6_full_pipeline.sh
# ============================================================================
...
# Output directory
OUTPUT_DIR="designs/ebpc-6"

# RFdiffusion parameters
NUM_DESIGNS=200
DESIGN_LOOPS="H1:10,H2:6,H3:16"
HOTSPOTS="A72,A73,A74"
DIFFUSER_T=50
