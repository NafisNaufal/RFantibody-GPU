...
# ============================================================================
# Full Antibody Design Pipeline — EBPC Target, Attempt 4
# ============================================================================
# Runs the complete antibody design workflow against the EBPC protein
# (PDB: 9LLW):
...
#
# Usage: CUDA_VISIBLE_DEVICES=0 bash gemastik-2026-scripts/rfantibody/ebpc-4_full_pipeline.sh
# ============================================================================
...
# Input files
TARGET_PDB="scripts/examples/example_inputs/EBPC_9LLW.pdb"
FRAMEWORK_PDB="scripts/examples/example_inputs/Scaffold.pdb"

# Output directory
OUTPUT_DIR="designs/ebpc-4"

# RFdiffusion parameters
NUM_DESIGNS=200
DESIGN_LOOPS="H1:10,H2:6,H3:16"
HOTSPOTS="A61,A62,A63,A64,A65,A67"
DIFFUSER_T=50
...
echo "=============================================="
echo "Antibody Design Pipeline — EBPC Target (9LLW)"
echo "Attempt 4"
echo "=============================================="
