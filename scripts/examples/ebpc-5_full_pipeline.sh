...
# ============================================================================
# Full Antibody Design Pipeline — EBPC Target, Attempt 5
# ============================================================================
...
#
# Usage: CUDA_VISIBLE_DEVICES=0 bash gemastik-2026-scripts/rfantibody/ebpc-5_full_pipeline.sh
# ============================================================================
...
# Output directory
OUTPUT_DIR="designs/ebpc-5"

# RFdiffusion parameters
NUM_DESIGNS=200
DESIGN_LOOPS="H1:10,H2:6,H3:16"
HOTSPOTS="A86,A88,A89,A92,A94"
DIFFUSER_T=50
